...
import 'package:admin/presentation/user_management/users_list_widget/users_list_widget.dart';
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 6),
              _buildLegendItem(Color.fromARGB(255, 200, 147, 253), 'Apple',
                '${controller.appleSignups.value.toString().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},')}'),
              const SizedBox(height: 6),
              _buildLegendItem(Color.fromARGB(255, 198, 210, 253), 'Email',
