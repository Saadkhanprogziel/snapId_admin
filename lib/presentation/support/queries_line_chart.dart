...
class QueriesLineChart extends StatelessWidget {
  ...
  Widget _buildChart(bool isDark) {
    ...
    // Calculate maxX based on actual data points
    // This ensures the chart fills the width properly
    ...
    return LineChart(
      LineChartData(
        ...
        titlesData: _getTitlesData(maxY, maxX),
  ...
  FlTitlesData _getTitlesData(double maxY, double maxX) {
    return FlTitlesData(
