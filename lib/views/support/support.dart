          ...
          children: [
           ...
           Row(
                    children: [
                      Expanded(
                        flex: 2,
                        child: QueriesLineChart(isMobile: isMobile, isTablet: isTablet),
                      ),
                      const SizedBox(width: 16),
                      Expanded(
                        flex: 1,
                        child: SupportStatusChart(isMobile: isMobile, isTablet: isTablet),
                      ),
                    ],
                  ),
  ...
  Widget _statusLegend() {
    return Obx(() => Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildStatusItem(controller.statusLabels['closed']!,
                controller.closedCount.value, controller.statusColors['closed']!),
          ],
        ));
  }
