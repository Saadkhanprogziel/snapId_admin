...
class OrderManagement extends StatelessWidget {
        ...
        children: [
          Expanded(
              child: _buildStatCard("Active Subscribers", "2,500", "28.4%",
                  true, "This month", Icons.group, Colors.blue)),
          SizedBox(width: isMobile ? 12 : 16),
          Expanded(
              child: _buildStatCard("Expiring Soon", "82", "8.4%", false,
                  "In next 24 hours", Icons.access_time, Colors.orange)),
          SizedBox(width: isMobile ? 12 : 16),
          Expanded(
              child: _buildStatCard("Top Plan Type", "Photo I", "0.4%", true,
                  "This month", Icons.diamond, Colors.purple)),
        ],
      );
    } else if (isTablet) {
      return Column(
      ...
      return Column(
        children: [
          _buildStatCard("Active Subscribers", "2,500", "28.4%", true,
              "This month", Icons.group, Colors.blue),
          SizedBox(height: 12),
  ...
  Widget _buildStatCard(String title, String value, String percentage,
      bool isPositive, String period, IconData icon, Color iconColor) {
    return Container(
