...
class OrdersListWidget extends StatelessWidget {
  ...
  Widget _buildTableRow(OrderData data,) {
    ...
    if (isMobile) {
      ...
      return Container(
        ...
        child: Row(
          children: 
              [
                  Expanded(flex: 2, child: Text(data.orderId, style: _rowStyle, overflow: TextOverflow.ellipsis)),
                  Expanded(flex: 3, child: Text("${data.amount}", style: _rowStyle, overflow: TextOverflow.ellipsis)),
      ...
      return Container(
        ...
        child: Row(
          children: [
                  ...
                  Expanded(flex: 2, child: Text(data.userEmail, style: _rowStyle, overflow: TextOverflow.ellipsis)),
                  Expanded(flex: 2, child: Text(data.amount.toString(), style: _rowStyle)),
                  Expanded(flex: 2, child: Text('${data.status}', style: _rowStyle)),
      ...
      return Container(
        ...
        child: Row(
          children:[
                  ...
                  Expanded(flex: 2, child: Text(data.status, style: _rowStyle)),
                  Expanded(flex: 3, child: Text(data.userEmail, style: _rowStyle, overflow: TextOverflow.ellipsis)),
                  Expanded(flex: 2, child: Text('${data.subscription}', style: _rowStyle)),
                  Expanded(flex: 2, child: Text('\$${data.amount.toStringAsFixed(2)}', style: _rowStyle)),
                  Expanded(flex: 2, child: Text(data.notes, style: _rowStyle,overflow: TextOverflow.ellipsis)),
