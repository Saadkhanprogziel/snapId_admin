...
class RequestAnalyticsChart extends StatelessWidget {
  ...
  Widget _buildLegend() {
    return Row(
      ...
      children: [
        _buildLegendItem('Mobile', const Color.fromARGB(255, 151, 135, 255)),
        const SizedBox(width: 24),
        _buildLegendItem('Web', const Color.fromARGB(255, 200, 147, 253)),
      ],
    );
  }
  ...
  Widget _buildChart(List<PlatformRequestData> data) {
