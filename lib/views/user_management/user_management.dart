...
class UserManagement extends StatelessWidget {
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ConstrainedBox(
                          ...
                          child: _buildTotalUsersCard(controller),
                        ),
                      ),
                      SizedBox(
                        width: cardWidth,
                        child: ConstrainedBox(
                          ...
                          child: _buildUsersPlatformCard(controller),
                        ),
                      ),
                      SizedBox(
                        width: cardWidth,
                        child: ConstrainedBox(
                          constraints: const BoxConstraints(minHeight: 300),
                          child: _buildUserStatusCard(controller),
                        ),
                      ),
                      SizedBox(
                        width: cardWidth,
                        child: ConstrainedBox(
                          constraints: const BoxConstraints(minHeight: 300),
                          child: _buildSignupMethodsCard(controller),
                        ),
                      ),
                    ],
                  ),
  ...
  Widget _buildTotalUsersCard(UserManagementController controller) {
  ...
  Widget _buildUsersPlatformCard(UserManagementController controller) {
    return Obx(() => Container(
  ...
  Widget _buildUserStatusCard(UserManagementController controller) {
    return Obx(() => Container(
          padding: const EdgeInsets.all(16),
          decoration: BoxDecoration(
            color: Colors.white,
                          ...
                          PieChartData(
                            sections: [
                              ...
                              PieChartSectionData(
                                ...
                                value:
                                    controller.suspendedUsers.value.toDouble(),
                                title: '',
                                radius: 11,
                              ),
                            ],
  ...
  Widget _buildSignupMethodsCard(UserManagementController controller) {
    return Obx(() => Container(
          padding: const EdgeInsets.all(16),
          decoration: BoxDecoration(
            color: Colors.white,
